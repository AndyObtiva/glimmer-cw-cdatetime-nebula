...
# -*- encoding: utf-8 -*-
# stub: glimmer-cw-cdatetime 1.0.0 ruby lib

Gem::Specification.new do |s|
  s.name = "glimmer-cw-cdatetime".freeze
  s.version = "1.0.0"
  ...
  s.date = "2020-07-18"
  s.description = "Nebula CDateTime - Glimmer Custom Widget".freeze
  ...
  s.files = [
    ...
    "README.md",
    "VERSION",
    "lib/glimmer-cw-cdatetime.rb",
    "lib/views/glimmer/c_date_time.rb",
    "vendor/nebula/org.eclipse.nebula.cwt_1.1.0.jar",
    "vendor/nebula/org.eclipse.nebula.widgets.cdatetime_1.4.0.jar"
  ]
  s.homepage = "http://github.com/AndyObtiva/glimmer-cw-cdatetime".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.0.6".freeze
  s.summary = "Nebula CDateTime - Glimmer Custom Widget".freeze
